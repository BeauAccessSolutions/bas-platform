...
|---|---|---|---|---|---|
| **Chronic Illness Tracker** | App #1 (PHI) | Next.js + Postgres | `Beaudoin0zach/Chronic-Illness-Tracker` (origin) · also old remote `kbeaudoin001/Chronic-Illness-Tracker` | ✅ pointer **merged to `main`** (PR #1) | 🟡 leading · AI date-range-timezone fix merged to `main` (2026-07-14) · a11y-spine fix (ApiForm live regions across 8 forms + `color-scheme`) merged PR #44 and landing/privacy voice copy merged PR #45 (2026-07-19) · a11y target-size fixes (nav controls, WCAG SC 2.5.8) **open** [PR #49](https://github.com/Beaudoin0zach/Chronic-Illness-Tracker/pull/49) from a `/bas-design-review` wayfinding pass (2026-07-20) |
